export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'labrignadu',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Labrignadu',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'labrignadu.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://labrignadu.com',
