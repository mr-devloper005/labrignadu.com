...
export const visualSystem = {
  ...
  surfaces: {
    glass: 'border border-[#B5B9F0]/15 bg-[#2E4540]/35 backdrop-blur-xl',
    paper: 'border border-[#B5B9F0]/15 bg-[#121817] shadow-[0_24px_70px_rgba(11,9,9,0.35)]',
    quiet: 'border border-[#B5B9F0]/10 bg-[#2E4540]/20',
    dark: 'border border-[#B5B9F0]/10 bg-[#0B0909]/80 shadow-[0_24px_70px_rgba(11,9,9,0.35)]',
  },
  layout: {
