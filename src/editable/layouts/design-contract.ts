...
export const editableRootStyle = {
  '--slot4-page-bg': '#0B0909',
  '--slot4-page-text': '#B5B9F0',
  '--slot4-panel-bg': '#121817',
  '--slot4-surface-bg': '#121817',
  '--slot4-muted-text': 'rgba(181,185,240,0.68)',
  '--slot4-soft-muted-text': 'rgba(181,185,240,0.5)',
  '--slot4-accent': '#408175',
  '--slot4-accent-fill': '#408175',
  '--slot4-accent-soft': 'rgba(64,129,117,0.22)',
  '--slot4-on-accent': '#0B0909',
  '--slot4-dark-bg': '#0B0909',
  '--slot4-dark-text': '#B5B9F0',
  '--slot4-media-bg': '#2E4540',
  '--slot4-cream': '#121817',
  '--slot4-warm': '#2E4540',
  '--slot4-lavender': '#B5B9F0',
  '--slot4-gray': '#2E4540',
  '--slot4-body-gradient': 'none',
  '--editable-page-bg': '#0B0909',
  '--editable-page-text': '#B5B9F0',
  '--editable-container': '1500px',
  '--editable-border': 'rgba(181,185,240,0.18)',
  '--editable-nav-bg': '#0B0909',
  '--editable-nav-text': '#B5B9F0',
  '--editable-nav-active': '#408175',
  '--editable-nav-active-text': '#0B0909',
  '--editable-cta-bg': '#B5B9F0',
  '--editable-cta-text': '#0B0909',
  '--editable-search-bg': '#121817',
  '--editable-footer-bg': '#0B0909',
  '--editable-footer-text': '#B5B9F0',
} as CSSProperties
...
export const editablePalette = {
  ...
  darkBorder: 'border-[#B5B9F0]/10',
  shadow: 'shadow-[0_1px_3px_rgba(11,9,9,0.28)]',
  shadowStrong: 'shadow-[0_4px_18px_rgba(11,9,9,0.34)]',
  overlay: 'bg-[linear-gradient(180deg,rgba(11,9,9,0.08),rgba(11,9,9,0.78))]',
} as const
...
export const editableDesignContract = {
  ...
  motion: {
    lift: 'transition duration-300 hover:-translate-y-1 hover:shadow-[0_8px_28px_rgba(11,9,9,0.34)]',
