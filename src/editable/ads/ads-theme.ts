...
export const adSkin: AdSkin = {
  ...
  shadow: '0 8px 30px rgba(11,9,9,0.28)',
  background: '#121817',
  labelClassName: 'bg-[#408175] text-[#0B0909]',
}

// Optional per-slot overrides — adjust only where you need to.
export const adSkinBySlot: Partial<Record<string, AdSkin>> = {
  sidebar: { radius: '12px', shadow: 'none', border: '1px solid rgba(181,185,240,0.18)' },
  popup: { radius: '24px' },
  header: { radius: '20px', background: '#121817' },
}
